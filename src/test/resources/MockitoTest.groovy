...
class MockitoTest extends Specification {
	...
	def 'mocking test'() {
		...
		1 * mocked.someOtherOtherMethod(_,_ as String,_ as String,'some string',null,!null,!null,_ as List<Object>,_ as Set<Object>,_ as Collection<Object>,_ as Iterable<Object>)
		0 * mockedList.clear()
